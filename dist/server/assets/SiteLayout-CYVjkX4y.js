...
function SiteLayout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { dangerouslySetInnerHTML: { __html: CSS } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "rk-nav", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "rk-brand", children: "AURA INTERIORS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-navgroup", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", activeOptions: { exact: true }, children: "Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", children: "Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", children: "About us" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-navright", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/projects", children: "Projects" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "rk-quote", children: "Get a Quote" })
        ] })
      ] }),
      children,
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "rk-footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rk-footer-brand", children: "AURA INTERIORS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rk-footer-desc", children: "Crafting refined, lasting interiors across Hyderabad. Every space we design is personal, considered, and built to endure." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-footer-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Navigate" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-footer-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", children: "Residential" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", children: "Commercial" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", children: "Turnkey" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", children: "Renovation" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-footer-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Contact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:hello@aurainteriors.in", children: "hello@aurainteriors.in" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919876543210", children: "+91 98765 43210" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { display: "block", fontSize: 13.5, color: "#444", padding: "4px 0" }, children: "Jubilee Hills, Hyderabad" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rk-footer-bottom", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Aura Interiors. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Designed with precision." })
    ] })
  ] });
}
function CTAButton({ to, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to, className: "rk-cta", children: [
...
function useFadeIn() {
  reactExports.useEffect(() => {
    ...
    document.querySelectorAll(".rk-fade-in").forEach((el) => observer.observe(el));
