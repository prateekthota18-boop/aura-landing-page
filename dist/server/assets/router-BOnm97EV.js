...
const appCss = "/assets/styles-REVI8O2d.css";
...
const $$splitComponentImporter$6 = () => import("./services-C0_RhGV0.js");
const Route$6 = createFileRoute("/services")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Residential, commercial and turnkey interior design services by Aura Interiors."
    }]
  })
});
const $$splitComponentImporter$5 = () => import("./projects-DDRLrWox.js");
const Route$5 = createFileRoute("/projects")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./contact-DsATclTy.js");
const Route$4 = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Aura Interiors to start your next project."
    }]
  })
});
const $$splitComponentImporter$3 = () => import("./about-vCPAWshm.js");
const Route$3 = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aura Interiors is a Hyderabad-based design studio crafting refined, lasting interiors."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./index-mhKy3M67.js");
const Route$2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aura Interiors crafts refined residential, commercial and turnkey interiors in Hyderabad."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./projects.index-BtNocPQK.js");
const Route$1 = createFileRoute("/projects/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Explore our portfolio of refined residential, commercial and turnkey interior projects in Hyderabad."
    }]
  })
});
const PROJECTS = [
...
const $$splitComponentImporter = () => import("./projects._projectId-DCrWm2jx.js");
const Route2 = createFileRoute("/projects/$projectId")({
  ...
  head: ({
    ...
    return {
      meta: [{
        ...
        name: "description",
        content: project?.brief ?? "Interior design project by Aura Interiors."
      }]
    };
  }
});
...
const ProjectsProjectIdRoute = Route2.update({
  id: "/$projectId",
  path: "/$projectId",
  getParentRoute: () => ProjectsRoute
});
