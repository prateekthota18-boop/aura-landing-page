...
function SiteFooter() {
  return (
    <footer className="rk-footer">
      <div>
        <div className="rk-footer-brand">AURA INTERIORS</div>
        <p className="rk-footer-desc">
          Crafting refined, lasting interiors across Hyderabad. Every space we design is personal, considered, and built to endure.
        </p>
      </div>
      ...
      <div className="rk-footer-col">
        <h4>Services</h4>
        <Link to="/services">Residential</Link>
        <Link to="/services">Commercial</Link>
        <Link to="/services">Turnkey</Link>
      ...
      <div className="rk-footer-col">
        ...
        <span style={{ display: "block", fontSize: 13.5, color: "#444", padding: "4px 0" }}>
